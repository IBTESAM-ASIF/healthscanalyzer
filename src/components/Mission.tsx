    ...
    <section className="py-24 bg-secondary/20">
      <div className="container px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold tracking-tighter mb-4 text-gradient glow">Our Mission</h2>
          ...
          <Card className="card-gradient border border-primary/20 card-glow">
            <CardHeader>
